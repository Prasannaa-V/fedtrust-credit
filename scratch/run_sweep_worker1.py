"""
scratch/run_sweep_worker1.py — Worker 1 for CONSISTENCY_GAIN sweep (0.5, 2.0)
...
for gain in gains:
    ...
    print(f"\n[WORKER 1] GAIN={gain} DONE in {elapsed/60:.1f}m | final_cons={final['global_consistency']:.4f} | ss_cons={ss_cons:.4f}\n")
